...
\item[SMM] режим работы процессора, используемый, как правило
	для настройки аппаратного обеспечения (англ. System Management Mode).
\item[SMI] прерывание, при возникновении которого, процессор
	переходит в SMM (англ. System Management Interrupt).
