...
#define VPT_SIZE		(0x8000000000) // 512 GB (NPDP_ENTRIES * NPD_ENTRIES * NPT_ENTRIES * PAGE_SIZE)
#define VPT			(KERNEL_BASE - VPT_SIZE)
#define VPD			PAGE_ADDR(PML4_IDX(VPT), PML4_IDX(VPT), 0, 0, 0)
#define VPDP			PAGE_ADDR(PML4_IDX(VPT), PML4_IDX(VPT), PML4_IDX(VPT), 0, 0)
#define VPML4			PAGE_ADDR(PML4_IDX(VPT), PML4_IDX(VPT), PML4_IDX(VPT), PML4_IDX(VPT), 0)
